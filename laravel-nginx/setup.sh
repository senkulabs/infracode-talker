...
# Step 1b: Install SQLite (CLI/library; php-sqlite3 above provides sqlite3 + pdo_sqlite PHP extensions)
install_sqlite() {
...
show_summary() {
    ...
    echo -e "=================================${NC}"
    echo ""
    echo -e "✅ PHP and Laravel extensions installed (includes sqlite3, pdo-sqlite)"
